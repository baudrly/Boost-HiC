...
dictchr = {"human": listchrhuman, "mouse": listchrmouse}
...
def loadchrsizedict(path, resolution):
    ...
    while l:
        ...
        if (
            F1 & F2 & F3 & F4
        ):  #!!!! CARE !!!! All that part from the dict is generated for a specific resolution
...
def givematrixsize(sizedict, chrlist, achr, chrindex):
    ...
    if chrindex == (Li - 1):
        ...
        return (
            sizedict["HicChrBegin" + chrlist[chrindex + 1]],
            sizedict["HicChrBegin" + achr],
        )
